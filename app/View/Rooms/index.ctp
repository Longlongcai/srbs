        ...
        <div class="col-sm-3 col-xs-6">
            <div class="panel panel-success">
                ...
                <div class="panel-footer">
                    <?php echo $this->Html->link($this->Html->tag('span', '', array('class' => 'glyphicon glyphicon-screenshot')).' 查看详情',array('controller' => 'rooms','action' =>'view','admin'=>false,$room['Room']['id']),array('escape'=>false,'class'=>'btn  btn-sm btn-success btn-block'));?>
                </div>
            </div>
        </div>
        <?php endforeach; ?>
